...
/**
 * Lesson02HumanCollaboration — CASE Academy
 * Módulo 06 · Ingeniería de Software Agéntica — Lección 02 (c17)
 * Formato: Living Technical Documentation
 */
@Component({
  selector: 'app-lesson-02-human-collaboration',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './lesson-02-human-collaboration.html',
  styleUrls: ['./lesson-02-human-collaboration.css']
})
export class Lesson02HumanCollaboration implements OnInit {
  private courseService = inject(CourseService);
  private userProgressService = inject(UserProgressService);

  readonly doc = LESSON_02_DOCUMENT;
  
  readonly lesson: Lesson | undefined = this.courseService.getLessonByPath('/academy/modules/m06-agentic-swe/lesson-02-human-collaboration');
  readonly module: AcademyModule | undefined = this.courseService.getModuleById('m6');
  readonly adjacentLessons = this.courseService.getAdjacentLessons('c17');
