...
Para profundidad técnica, ejemplos completos y criterios docentes consulta también [el material docente de M05](../../m05-ai-agents/README.md).

## Principio de conducción del módulo

M05 debe sentirse como la construcción progresiva de un agente, no como una colección de definiciones aisladas.
